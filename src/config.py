# config.py
#
# PURPOSE: Shared constants used across all visualization scripts.
# Centralising these here means changing a club color or pitch style
# only needs to happen in one place — not in four separate scripts.
#
# WHY THIS EXISTS (DRY principle):
# Having CLUB_COLORS copied into every script meant they could drift apart.
# Any script that imports from here will always get the same values.
